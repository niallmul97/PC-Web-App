...
app.get('/user/:userId', builds.findByOs);
...
app.put('/builds/:buildId/parts/:partId', builds.updateCPU);
app.put('/builds/:buildId/parts/:partId', builds.updateGPU);
app.put('/builds/:buildId/parts/:partId', builds.updateRAM);
app.put('/builds/:buildId/parts/:partId', builds.updateStorage);
app.put('/builds/:buildId/parts/:partId', builds.updateOS);
